package com.yobin.stee.rxjavasimple.module.cache_6.data;

import com.google.gson.Gson;
import com.google.gson.reflect.TypeToken;
import com.yobin.stee.rxjavasimple.App;
...
public class Database {
    ...
    private static Database INSTANCE;
     ...
     File dataFile = new File(App.getInstance().getFilesDir()+File.separator+DATA_FILE_NAME);
